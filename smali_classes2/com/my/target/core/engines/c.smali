...
.method public constructor <init>(Lcom/my/target/nativeads/NativeAppwallAd;Landroid/view/ViewGroup;Landroid/content/Context;)V
    ...
    .line 1031
    new-instance p1, Lcom/my/target/nativeads/views/AppwallAdView;

    iget-object p2, p0, Lcom/my/target/core/engines/c;->b:Landroid/content/Context;

    invoke-direct {p1, p2}, Lcom/my/target/nativeads/views/AppwallAdView;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/my/target/core/engines/c;->d:Lcom/my/target/nativeads/views/AppwallAdView;

    .line 1032
    iget-object p1, p0, Lcom/my/target/core/engines/c;->d:Lcom/my/target/nativeads/views/AppwallAdView;

    iget-object p2, p0, Lcom/my/target/core/engines/c;->c:Lcom/my/target/nativeads/NativeAppwallAd;

    invoke-virtual {p1, p2}, Lcom/my/target/nativeads/views/AppwallAdView;->setupView(Lcom/my/target/nativeads/NativeAppwallAd;)V

    .line 1033
    iget-object p1, p0, Lcom/my/target/core/engines/c;->d:Lcom/my/target/nativeads/views/AppwallAdView;

    invoke-virtual {p1, p0}, Lcom/my/target/nativeads/views/AppwallAdView;->setBannerClickListener(Lcom/my/target/nativeads/views/AppwallAdView$BannerClickListener;)V
    ...
    invoke-virtual {p1, p2}, Lcom/my/target/nativeads/views/AppwallAdView;->setVisibility(I)V

    .line 1035
    iget-object p1, p0, Lcom/my/target/core/engines/c;->d:Lcom/my/target/nativeads/views/AppwallAdView;

    invoke-virtual {p1, p0}, Lcom/my/target/nativeads/views/AppwallAdView;->setBannerVisibilityListener(Lcom/my/target/nativeads/views/AppwallAdView$BannerVisibilityListener;)V
    ...
    .line 1038
    iget-object p2, p0, Lcom/my/target/core/engines/c;->d:Lcom/my/target/nativeads/views/AppwallAdView;

    invoke-virtual {p2, p1}, Lcom/my/target/nativeads/views/AppwallAdView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 1040
    iget-object p1, p0, Lcom/my/target/core/engines/c;->a:Landroid/view/ViewGroup;
