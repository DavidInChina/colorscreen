...
.method private a(Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V
    .locals 1
    ...
    invoke-direct {p0, v0, p2, p3}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/util/List;Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/util/List;Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V

    return-void
.end method

.method private a(Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V
    .locals 4
...
.method private a(Ljava/util/List;Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 53
    invoke-direct {p0, v1, p2, p3}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method private static b(Ljava/lang/Class;)Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;
    ...
    invoke-static {v1, v8, v7, p0}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/util/Map;Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V
    ...
    .line 129
    const-class v6, Landroid/arch/lifecycle/f;

    invoke-virtual {v5, v6}, Ljava/lang/reflect/Method;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v6

    check-cast v6, Landroid/arch/lifecycle/f;
    ...
    .line 142
    :goto_3
    invoke-interface {v6}, Landroid/arch/lifecycle/f;->a()Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    .line 159
    invoke-static {v1, v7, v6, p0}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/util/Map;Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V
...
# virtual methods
.method public a(Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V
    .locals 1
    ...
    invoke-direct {p0, v0, p1, p2}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;Landroid/arch/lifecycle/b;Landroid/arch/lifecycle/Lifecycle$Event;)V
