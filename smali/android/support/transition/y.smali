...
.method private k()V
    ...
    .line 365
    invoke-virtual {v2, v0}, Landroid/support/transition/u;->a(Landroid/support/transition/u$b;)Landroid/support/transition/u;
...
.method public synthetic a(Landroid/support/transition/u$b;)Landroid/support/transition/u;
    .locals 0

    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/y;->c(Landroid/support/transition/u$b;)Landroid/support/transition/y;
...
.method public synthetic b(Landroid/support/transition/u$b;)Landroid/support/transition/u;
    .locals 0

    .line 60
    invoke-virtual {p0, p1}, Landroid/support/transition/y;->d(Landroid/support/transition/u$b;)Landroid/support/transition/y;
...
.method public b(Landroid/view/View;)V
    ...
    .line 504
    invoke-super {p0, p1}, Landroid/support/transition/u;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/transition/u;->b(Landroid/view/View;)V
...
.method public c(Landroid/support/transition/u$b;)Landroid/support/transition/y;
    .locals 0

    .line 255
    invoke-super {p0, p1}, Landroid/support/transition/u;->a(Landroid/support/transition/u$b;)Landroid/support/transition/u;
...
.method public c(Landroid/view/View;)V
    ...
    .line 515
    invoke-super {p0, p1}, Landroid/support/transition/u;->c(Landroid/view/View;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/transition/u;->c(Landroid/view/View;)V
...
.method public synthetic clone()Ljava/lang/Object;
    ...
    .line 60
    invoke-virtual {p0}, Landroid/support/transition/y;->i()Landroid/support/transition/u;
...
.method public d(Landroid/support/transition/u$b;)Landroid/support/transition/y;
    .locals 0

    .line 333
    invoke-super {p0, p1}, Landroid/support/transition/u;->b(Landroid/support/transition/u$b;)Landroid/support/transition/u;
...
.method protected e()V
    ...
    .line 441
    :cond_0
    invoke-direct {p0}, Landroid/support/transition/y;->k()V
    ...
    invoke-virtual {v1, v3}, Landroid/support/transition/u;->a(Landroid/support/transition/u$b;)Landroid/support/transition/u;
...
.method public i()Landroid/support/transition/u;
    ...
    .line 583
    invoke-super {p0}, Landroid/support/transition/u;->i()Landroid/support/transition/u;
    ...
    invoke-virtual {v3}, Landroid/support/transition/u;->i()Landroid/support/transition/u;
