...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/design/widget/f;->b(Landroid/view/animation/Interpolator;)V
    ...
    .line 249
    invoke-static {p3, v1}, Landroid/support/design/widget/u;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method private c(Z)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/f;->b(F)V
...
.method private setEditText(Landroid/widget/EditText;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/f;->c(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/f;->a(F)V
...
.method a(ZZ)V
    ...
    .line 442
    iget-object v4, p0, Landroid/support/design/widget/TextInputLayout;->d:Landroid/support/design/widget/f;

    iget-object v5, p0, Landroid/support/design/widget/TextInputLayout;->H:Landroid/content/res/ColorStateList;

    invoke-virtual {v4, v5}, Landroid/support/design/widget/f;->b(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/design/widget/f;->a(Landroid/content/res/ColorStateList;)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p0, p2, p1}, Landroid/support/design/widget/r;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/f;->i()V
...
.method public setHintTextAppearance(I)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/f;->k()Landroid/content/res/ColorStateList;
