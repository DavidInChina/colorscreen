...
.method public constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    .line 1522
    invoke-virtual {p0, p1}, Landroid/support/design/widget/TabLayout$f;->setGravity(I)V

    const/4 p1, 0x1

    .line 1523
    invoke-virtual {p0, p1}, Landroid/support/design/widget/TabLayout$f;->setOrientation(I)V

    .line 1524
    invoke-virtual {p0, p1}, Landroid/support/design/widget/TabLayout$f;->setClickable(Z)V
...
.method private a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 1728
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$f;->b:Landroid/support/design/widget/TabLayout$e;
    ...
    .line 1729
    :goto_0
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$f;->b:Landroid/support/design/widget/TabLayout$e;
    ...
    .line 1730
    :goto_1
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$f;->b:Landroid/support/design/widget/TabLayout$e;
    ...
    .line 1736
    invoke-virtual {p0, v5}, Landroid/support/design/widget/TabLayout$f;->setVisibility(I)V
...
.method a()V
    ...
    .line 1656
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout$f;->a(Landroid/support/design/widget/TabLayout$e;)V
...
.method a(Landroid/support/design/widget/TabLayout$e;)V
    ...
    .line 1650
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$f;->b:Landroid/support/design/widget/TabLayout$e;
...
.method final b()V
    ...
    .line 1672
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$f;->c:Landroid/widget/TextView;
    ...
    .line 1675
    :cond_3
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$f;->d:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$f;->f:Landroid/widget/TextView;

    .line 1681
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$f;->f:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$f;->g:Landroid/widget/ImageView;

    goto :goto_1

    .line 1687
    :cond_6
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$f;->e:Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Landroid/support/design/widget/TabLayout$f;->removeView(Landroid/view/View;)V
    ...
    .line 1695
    :goto_1
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$f;->e:Landroid/view/View;
    ...
    .line 1700
    invoke-virtual {p0, v1, v2}, Landroid/support/design/widget/TabLayout$f;->addView(Landroid/view/View;I)V

    .line 1701
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$f;->d:Landroid/widget/ImageView;
    ...
    .line 1707
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$f;->c:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$f;->a:Landroid/support/design/widget/TabLayout;
    ...
    invoke-direct {p0, v1, v3}, Landroid/support/design/widget/TabLayout$f;->a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$f;->g:Landroid/widget/ImageView;
    ...
    :cond_e
    invoke-virtual {p0, v2}, Landroid/support/design/widget/TabLayout$f;->setSelected(Z)V
...
.method public onMeasure(II)V
    ...
    .line 1595
    :cond_0
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$f;->a:Landroid/support/design/widget/TabLayout;
    ...
    .line 1610
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$f;->d:Landroid/widget/ImageView;
    ...
    .line 1613
    :cond_2
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$f;->c:Landroid/widget/TextView;
    ...
    .line 1626
    :cond_4
    iget-object v5, p0, Landroid/support/design/widget/TabLayout$f;->a:Landroid/support/design/widget/TabLayout;
    ...
    .line 1633
    invoke-direct {p0, v2, v6, v0}, Landroid/support/design/widget/TabLayout$f;->a(Landroid/text/Layout;IF)F
...
.method public performClick()Z
    ...
    .line 1533
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$f;->b:Landroid/support/design/widget/TabLayout$e;
