.class public Lcootek/bbase/daemon/strategy/DaemonStrategy24;
...
.method private initAmsBinder()V
    ...
    iput-object v0, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mRemote:Landroid/os/IBinder;
    :try_end_0
...
.method private initBroadcastParcel(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mBroadcastData:Landroid/os/Parcel;

    .line 163
    iget-object p2, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mBroadcastData:Landroid/os/Parcel;
    ...
    .line 168
    iget-object p1, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mBroadcastData:Landroid/os/Parcel;
...
.method private initIndicatorFiles(Landroid/content/Context;)Z
    ...
    .line 204
    invoke-direct {p0, p1, v0}, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->createNewFile(Ljava/io/File;Ljava/lang/String;)V
...
.method private sendBroadcastByAmsBinder()Z
    ...
    .line 184
    :try_start_0
    iget-object v1, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mRemote:Landroid/os/IBinder;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mBroadcastData:Landroid/os/Parcel;
    ...
    iget-object v3, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mBroadcastData:Landroid/os/Parcel;
...
.method public onDaemonAssistantCreate(Landroid/content/Context;Lcootek/bbase/daemon/mars/DaemonConfigurations;)V
    ...
    .line 75
    invoke-direct {p0}, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->initAmsBinder()V
    ...
    invoke-direct {p0, p1, v0}, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->initBroadcastParcel(Landroid/content/Context;Ljava/lang/String;)V

    .line 77
    invoke-direct {p0}, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->sendBroadcastByAmsBinder()Z

    .line 79
    new-instance v0, Lcootek/bbase/daemon/strategy/DaemonStrategy24$2;

    invoke-direct {v0, p0, p1}, Lcootek/bbase/daemon/strategy/DaemonStrategy24$2;-><init>(Lcootek/bbase/daemon/strategy/DaemonStrategy24;Landroid/content/Context;)V
    ...
    .line 97
    iput-object p2, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mConfigs:Lcootek/bbase/daemon/mars/DaemonConfigurations;
...
.method public onDaemonDead()V
    ...
    .line 107
    iget-object v0, p0, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->mConfigs:Lcootek/bbase/daemon/mars/DaemonConfigurations;
...
.method public onInitialization(Landroid/content/Context;)Z
    ...
    .line 41
    invoke-direct {p0, p1}, Lcootek/bbase/daemon/strategy/DaemonStrategy24;->initIndicatorFiles(Landroid/content/Context;)Z
...
.method public onPersistentCreate(Landroid/content/Context;Lcootek/bbase/daemon/mars/DaemonConfigurations;)V
    ...
    .line 50
    new-instance v0, Lcootek/bbase/daemon/strategy/DaemonStrategy24$1;

    invoke-direct {v0, p0, p1}, Lcootek/bbase/daemon/strategy/DaemonStrategy24$1;-><init>(Lcootek/bbase/daemon/strategy/DaemonStrategy24;Landroid/content/Context;)V
